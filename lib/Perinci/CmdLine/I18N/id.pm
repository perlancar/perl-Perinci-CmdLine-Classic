...
"Opsi undo:\n"
"\n"
"    --undo <ID>     Batalkan tindakan sebelumnya (ID dari --list-history)\n"
"    --redo <ID>     Ulangi tindakan sebelumnya (ID dari --list-history)\n"
"    --list-history  Daftar sejarah tindakan sebelumnya\n"
